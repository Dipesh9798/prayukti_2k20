...
.catch(function(error){
 ...
 // console.log(firebase.auth().currentUser);
  ...
  //  console.log(firebase.auth().currentUser);
   ...
   college_roll = document.getElementById('roll').value;
   college_code = "H";
     ...
     // .get()
      //.then( snapshot =>{
       // if(snapshot.empty){
          ...
          if(name==="" && email ==="" && dob==="" && college_roll==="")
          {
...
function checkboxes()
        ...
        document.getElementByClassName('events').onclick=function(){
          var abc=document.getElementByClassN  ame("events");
...
function event_register(){
  ...
  if(user){
     ...
     /* var userDocData = {
       ...
       // user_profile_img: user_profile_img,
        user_college : values.user_college,
      ...
      /*var events={
        events_reg:arr};*/
      //prompt("chup kro")
      firebase.firestore().collection("inhouse_database")
      .doc(user_uid)
